      ...
      <div className="max-w-4xl mx-auto pt-8 px-4 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
            ...
            <div className="p-4 border-2 border-[#842A3B] bg-[#842A3B]/5 rounded-2xl">
              ...
              <p className="text-xs text-slate-500 mt-1">{user.address}</p>
            </div>
          </div>
        ...
        <div className="md:col-span-5">
          <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 sticky top-24">
            <h2 className="font-black text-[#842A3B] text-xs uppercase tracking-[0.2em] mb-2">
              Ordering from
            </h2>
            <h3 className="font-black text-xl text-slate-800 mb-6 truncate">
              {restaurantName}
            </h3>
            ...
            <div className="pt-6 mb-8 flex justify-between items-end">
              <div>
                <span className="text-[10px] font-black text-[#842A3B] uppercase tracking-widest">
                  Total to pay
                </span>
            ...
            <button
              className="w-full bg-[#842A3B] text-white py-5 rounded-2xl font-black uppercase text-sm tracking-widest shadow-lg shadow-[#842A3B]/30 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2"
